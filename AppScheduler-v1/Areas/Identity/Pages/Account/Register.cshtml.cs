...
namespace AppScheduler_v1.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _userManager.AddToRoleAsync(user, "Patient"); //adds Patient role by default to every user that is created
